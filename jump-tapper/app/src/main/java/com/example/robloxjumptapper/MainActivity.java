...
public class MainActivity extends Activity {
    ...
    @Override protected void onCreate(Bundle savedInstanceState) {
        ...
        TextView title = new TextView(this); title.setText("Jump Tapper v1.12"); title.setTextSize(28); title.setTypeface(Typeface.DEFAULT_BOLD); root.addView(title);
        ...
        TextView debugNote=new TextView(this);debugNote.setText("The log records START/STOP, tap request time, whether Android accepted it, completion/cancel time, duration, and skipped taps. It is capped automatically so it stays small.");debugNote.setTextSize(12);root.addView(debugNote);
    ...
    private void shareLog(){Intent s=new Intent(Intent.ACTION_SEND);s.setType("text/plain");s.putExtra(Intent.EXTRA_SUBJECT,"Jump Tapper v1.12 Debug Log");s.putExtra(Intent.EXTRA_TEXT,readLog());startActivity(Intent.createChooser(s,"Share debug log"));}
